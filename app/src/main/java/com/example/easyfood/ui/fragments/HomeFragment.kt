...
class HomeFragment : Fragment(R.layout.fragment_home) {
    ...
    // Fragment içerisinde kullanılan sabitler
    companion object{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Yüklenirken durum gösterimi
        showLoadingCase()

        // RecyclerView'lerin hazırlanması ve tıklama işlemlerinin dinlenmesi
        prepareCategoryRecyclerView()
        preparePopularMeals()
        onRndomMealClick()
        onRandomLongClick()

        // Kategorilere ve popüler yemeklere ait verilerin dinlenmesi
        ...
        // Popüler yemeklerde tıklama işlemi
        ...
        // Popüler yemeklerde uzun tıklama işlemi
        ...
        // Arama simgesine tıklama işlemi
        binding.imgSearch.setOnClickListener {
            findNavController().navigate(R.id.action_homeFragment_to_searchFragment)
        }
    }

    // Rastgele yemeğe tıklama işlemi
    ...
    // Rastgele yemeğe uzun tıklama işlemi
    ...
    // Popüler yemeklerin RecyclerView'nin hazırlanması
